...
<img style="float: left; width: 2cm; padding:15px" src="{{site.baseurl}}/assets/img/usc.png"> 
        <a href="http://www.usc.edu">University of Southern California</a><br>
        Doctor of Philosophy (Ph.D.), Computer Science <br>
        2014 - present<br><br>

<img style="float: left; width: 2cm; padding:15px" src="{{site.baseurl}}/assets/img/mcgill.png"> 
