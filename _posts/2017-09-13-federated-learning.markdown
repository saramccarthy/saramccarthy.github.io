...
<p> Differential privacy is a formal privacy definition which roughly defines an algorithm as “private” if it is not sensitive to any individual data point (or any small group of data points). 
<br><br>
