...
<div style="width:100%">
    <div style="width:45%;min-width: 200px !important; display:inline-block;padding-right:20px" ><img src="{{site.baseurl}}/assets/img/riskmap.png"> </div>
    <div style="width:45%;display:inline-block;margin:auto;" ><strong> Team Building Problem </strong> 
<br>
